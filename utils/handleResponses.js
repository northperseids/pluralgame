const { countemojis, votetimer } = require('./vals.json')

module.exports.handleResponses = async function handleResponses(interaction, conn, botmessage, question, gameid, timers, client) {
